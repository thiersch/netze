...
flowchart TB
  %% Erst die Knoten in gewünschter Reihenfolge listen:
  L5["Layer 5: Prozesse"]
  L4["Layer 4: TCP oder UDP"]
  L3["Layer 3: Internetprotokoll"]

  %% Dann die Kanten — primäre Kette zuerst:
  L5 -->|benutzt| L4
  L4 -->|benutzt| L3

  %% Rückwärts-Pfeile (zeigen die Gegenrichtung ohne die Reihenfolge zu zerstören):
  L4 -->|dient| L5
  L3 -->|dient| L4
