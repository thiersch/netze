...
const FeatureList = [
  {
    ...
    image: require('@site/static/img/baer1.png').default,
    description: (
      <>
  ...
  },
  {
    ...
    image: require('@site/static/img/baer2.png').default,
    description: (
      <>
  ...
  },
  {
    ...
    image: require('@site/static/img/baer3.png').default,
    description: (
      <>
...
function Feature({title, title, description}) {
  return (
